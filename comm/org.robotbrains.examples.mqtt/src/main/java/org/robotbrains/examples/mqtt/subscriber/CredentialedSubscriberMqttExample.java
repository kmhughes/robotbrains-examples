...
/**
 * An MQTT example that subscribes on a topic. It logs into the broker.
 * 
 * @author Keith M. Hughes
 */
public class CredentialedSubscriberMqttExample {
  public static void main(String[] args) {
    ...
    try {
      ...
      MqttClient client =
          new MqttClient("tcp://smartspaces.io:1883", "/mqtt/subscriber/credentialed", persistence);
