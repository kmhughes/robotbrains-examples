...
public class StandardDataWebServer implements DataWebServer {
  ...
  private void handleDataRequest(HttpRequest request, HttpResponse response) {
    try {
      ...
      for (SensorDataSample sample : data.samples()) {
        Map<String, Object> sampleMap = new HashMap<>();
        sampleMap.put(DATA_RESULT_FIELD_SAMPLE_TIMESTAMP, sample.timestamp());
        sampleMap.put(DATA_RESULT_FIELD_SAMPLE_VALUE, sample.value());
